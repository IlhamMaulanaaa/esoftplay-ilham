    ...
    <main id="contents" class="site-contnts">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="media service-quote">
                                    <div class="media-left"><a href="#" class="media-object"><img src="assets/images/service-quote.png" alt="HostPro Client image" class="img-circle"></a></div>
                                    <div class="media-body">
                                        <p><em>Love the support from HostPro team! WordPress hosting boosted my theme business.</em></p>
                                        <h4>Jane Sanders</h4>
                                        <h5>Themeworks</h5>
                                    </div>
                                    <div class="media-right"><span class="media-object"><img src="assets/icons/service-quote2.png" alt="HostPro Service Quote Sign"></span></div>
                                </div>
                            </div>
               ...
               <div class="row">
                   <div class="col-sm-6 col-md-4 why-to-choose">
                       <div class="row wtc-inner text-center">
                           <div class="row wtc-icon"><img src="assets/icons/wc1.png" alt="HostPro Service Icon"></div>
                   ...
                   <div class="col-sm-6 col-md-4 why-to-choose">
                       <div class="row wtc-inner text-center">
                           <div class="row wtc-icon"><img src="assets/icons/wc2.png" alt="HostPro Service Icon"></div>
                   ...
                   <div class="col-sm-6 col-md-4 why-to-choose">
                       <div class="row wtc-inner text-center">
                           <div class="row wtc-icon"><img src="assets/icons/wc3.png" alt="HostPro Service Icon"></div>
                   ...
                   <div class="col-sm-6 col-md-4 why-to-choose">
                       <div class="row wtc-inner text-center">
                           <div class="row wtc-icon"><img src="assets/icons/wc4.png" alt="HostPro Service Icon"></div>
                   ...
                   <div class="col-sm-6 col-md-4 why-to-choose">
                       <div class="row wtc-inner text-center">
                           <div class="row wtc-icon"><img src="assets/icons/wc5.png" alt="HostPro Service Icon"></div>
                   ...
                   <div class="col-sm-6 col-md-4 why-to-choose">
                       <div class="row wtc-inner text-center">
                           <div class="row wtc-icon"><img src="assets/icons/wc6.png" alt="HostPro Service Icon"></div>
            ...
            <div class="container">
                ...
                <div id="customer-testimonial" class="customer-testimonial carousel slide" data-ride="carousel">
                    ...
                    <ol class="carousel-indicators ct-indicator imgv">
                        <li data-target="#customer-testimonial" data-slide-to="0"><img src="assets/images/ct1.jpg" alt="Customer Image"></li>
                        <li data-target="#customer-testimonial" data-slide-to="1" class="active"><img src="assets/images/ct3.jpg" alt="Customer Image"></li>
                        <li data-target="#customer-testimonial" data-slide-to="2"><img src="assets/images/ct2.jpg" alt="Customer Image"></li>
                    </ol>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-4 latest-post">
                        <img src="assets/images/lpost1.jpg" alt="A galley of type and scrambled it to make a type." class="img-responsive">
                        <div class="lp-inner row">
                            ...
                            <a href="blog-post.html"><h2 class="lp-title">A galley of type and scrambled it to make a type.</h2></a>
                        </div>
                    </div>
                    <div class="col-sm-4 latest-post">
                        <img src="assets/images/lpost2.jpg" alt="Lorem Ipsum has been the industry's standard." class="img-responsive">
                        <div class="lp-inner row">
                            <ul class="lp-meta list-unstyled">
                                <li class="lp-cat"><em>in</em> <a href="#">data</a>, <a href="#">ssd</a>, <a href="#">intel</a></li>
                                <li class="lp-date"><a href="#">Feb 18, 2016</a></li>
                            </ul>
                            <a href="blog-post.html"><h2 class="lp-title">Lorem Ipsum has been the industry's standard.</h2></a>
                        </div>
                    </div>
                    <div class="col-sm-4 latest-post">
                        <img src="assets/images/lpost3.jpg" alt="A galley of type and scrambled it to make a type." class="img-responsive">
                        <div class="lp-inner row">
                            <ul class="lp-meta list-unstyled">
                                <li class="lp-cat"><em>in</em> <a href="#">data</a>, <a href="#">ssd</a>, <a href="#">intel</a></li>
                                <li class="lp-date"><a href="#">Feb 18, 2016</a></li>
        ...
        <section class="row client-logos">
            <div class="container">            
                ...
                <div class="row">
                    <div class="col-sm-2 client-logo"><a href="index.html" data-toggle="tooltip" data-placement="top" title="Adobe"><img src="assets/images/client1.png" alt="Adobe"></a></div>
                    <div class="col-sm-2 client-logo"><a href="index.html" data-toggle="tooltip" data-placement="top" title="Huawei"><img src="assets/images/client2.png" alt="Huawei"></a></div>
                    <div class="col-sm-2 client-logo"><a href="index.html" data-toggle="tooltip" data-placement="top" title="One Plus"><img src="assets/images/client3.png" alt="One Plus"></a></div>
                    <div class="col-sm-2 client-logo"><a href="index.html" data-toggle="tooltip" data-placement="top" title="Mitsubishi"><img src="assets/images/client4.png" alt="Mitsubishi"></a></div>
                    <div class="col-sm-2 client-logo"><a href="index.html" data-toggle="tooltip" data-placement="top" title="Samsung"><img src="assets/images/client5.png" alt="Samsung"></a></div>
                    <div class="col-sm-2 client-logo"><a href="index.html" data-toggle="tooltip" data-placement="top" title="Under Armour"><img src="assets/images/client6.png" alt="Under Armour"></a></div>
                </div>
            </div>
        </section>
