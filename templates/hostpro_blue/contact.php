...
<head>
    ...
    <!--Site Title-->
    <title>Contact Us - Host-Pro</title>
...
<body>
    ...
    <div id="page" class="site row">
        ...
        <main id="contents" class="site-contnts">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 contact-form-box contact-box">
                            <h2 class="cb-title">Send us <strong>Message</strong></h2>
                            ...
                            <form id="contactForm" method="post" class="contact-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="message" id="message" rows="10" class="form-control" placeholder="Enter text here "></textarea>
                                </div>
                        ...
                        <div class="col-sm-6 contact-info-box contact-box">
                            <div class="row contact-ibox">
                                ...
                                <ul class="media-list contact-infolist">
                                    <li class="media">
                                        <div class="media-left"><span class="media-object"><img src="assets/icons/cion1.png" alt="Contact Icon 1"></span></div>
                                        <div class="media-body">301 Neymer Road, Glassgow, opposite of denclave zone, WA 1201-403.</div>
                                    </li>
                                    <li class="media">
                                        <div class="media-left"><span class="media-object"><img src="assets/icons/cion2.png" alt="Contact Icon 2"></span></div>
                                        <div class="media-body"><a href="tel:+11234567890">+1 123 456 7890</a></div>
                                    </li>
                                    <li class="media">
                                        <div class="media-left"><span class="media-object"><img src="assets/icons/cion3.png" alt="Contact Icon 3"></span></div>
                                        <div class="media-body"><a href="tel:+11234567890">+1 123 456 7890</a></div>
                                    </li>
                                    <li class="media">
                                        <div class="media-left"><span class="media-object"><img src="assets/icons/cion4.png" alt="Contact Icon 4"></span></div>
                                        <div class="media-body"><a href="mailto:info@bootstrapmart.com">info@bootstrapmart.com</a></div>
                                    </li>
                                </ul>
                            </div>
                            <div class="row contact-ibox">
                                ...
                                <ul class="media-list contact-infolist">
                                    <li class="media">
                                        <div class="media-left"><span class="media-object"><img src="assets/icons/cion5.png" alt="Contact Icon 1"></span></div>
                                        <div class="media-body"><a href="#">Chat Support</a></div>
                                    </li>
                                    <li class="media">
                                        <div class="media-left"><span class="media-object"><img src="assets/icons/cion6.png" alt="Contact Icon 2"></span></div>
            ...
            <div class="row m0 gmapbox" data-lat="37.3818288" data-lon="-122.0636325" data-zoom="15" data-marker="assets/icons/map-marker.png"></div>
            <div class="row contact-c2a">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-7">
                        ...
                        <div class="col-sm-5">
                            <div class="media">
                                <div class="media-left media-bottom"><span class="media-object"><img src="assets/icons/phone2.png" alt="Call Us Now"></span></div>
                                <div class="media-body">
                                    <h2 class="h4">Call us Now</h2>
    ...
    <script src="vendors/gmaps.min.js"></script>
