				...
				<div id="customer-testimonial" class="customer-testimonial carousel slide" data-ride="carousel">
						...
						<ol class="carousel-indicators ct-indicator imgv">
							...
							foreach ($output['data'] as $key => $data) 
							{
								$cls = $key  === 0 ? ' active' : '';
								?>
								<li data-target="#customer-testimonial" data-slide-to="<?php echo $key ?>" class="<?php $cls ?>"><img src="<?php echo 'https://gravatar.com/avatar/' . md5($data['email']) ?>" alt="Customer Image"></li>
								<?php
							}
							?>
						</ol>
